...
static void setIdeaOnAnimal(Animal* animal, int idx, const std::string& idea) {
...
static std::string getIdeaFromAnimal(const Animal* animal, int idx) {
...
int main() {
	section("Basic polymorphism and deletion");
